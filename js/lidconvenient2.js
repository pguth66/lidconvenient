	...
	for ( i = 1 ; i <= runs ; i++ ) {
		...
		switch(strategy) {
			case "PIU":
				...
				if ( !isMan  ||  ( isMan &&isNumberTwo)) {
					numInconv++ ;
				}
				document.getElementById("col3runs").innerHTML =  i;
				document.getElementById("col3inconv").innerHTML = numInconv ;
				document.getElementById("col3inconvpercent").innerHTML = (((numInconv / i) / 2).toFixed(2) * 100 ) + "%" ;
				break ;
			case "PID":
				...
				document.getElementById("col1inconvpercent").innerHTML = (((numInconv / i) / 2).toFixed(2) * 100 ) + "%";
				break ;
			case "LIR":
				document.getElementById("col2runs").innerHTML =  i;
				document.getElementById("col2inconv").innerHTML = numInconv ;
				document.getElementById("col2inconvpercent").innerHTML = (((numInconv / i) / 2).toFixed(2) * 100) + "%" ;
